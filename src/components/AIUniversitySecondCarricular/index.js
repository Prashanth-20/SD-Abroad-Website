...
const AIUniversitySecondCarricular = () => (
  <>
    <Header />
        ...
        <div className="images-tag-text-box">
          <div className="shadow-carricular-box">
            <div>
              ...
              />
              <p className="carricular-image-text">Sports</p>
            </div>
          </div>
          ...
          <div className="shadow-carricular-box">
            <div>
              <img
                ...
                className="shadow-image"
              />
              <p className="carricular-image-text">Competitions</p>
            </div>
          </div>
          ...
          <div className="shadow-carricular-box">
            <div>
              <img
                ...
                className="shadow-image"
              />
              <p className="carricular-image-text">Clubs</p>
            </div>
          </div>
          ...
          <div className="shadow-carricular-box">
            <div>
              <img
                ...
                className="shadow-image"
              />
              <p className="carricular-image-text">NGOs</p>
            </div>
          </div>
        </div>
...
export default AIUniversitySecondCarricular
